<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateStudentUI.aspx.cs" Inherits="VersityWebApp.UI.UpdateStudentUI" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:HyperLink ID="indexHyperLink" runat="server" NavigateUrl="~/UI/IndexUI.aspx">Home Page</asp:HyperLink>
            <br />
            <br />
            <div>
            <table>
